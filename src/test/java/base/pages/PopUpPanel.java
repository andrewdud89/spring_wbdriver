...
public class PopUpPanel extends BasePanel {
    ...
    public PopUpPanel(WebDriver driver, WebElement root) {
        super(driver, root);
    }
...
//    TODO change architecture using waitForElementPresent and sleep
