...
public abstract class BasePage {
    ...
    public boolean waitForReadyStateComplete() {
        return new WebDriverWait(webDriver, DEFAULT_EXPLICIT_WAIT).until((ExpectedCondition<Boolean>) wd ->
    ...
    public Object executeJS(String jsCode, WebElement element) {
        try {
            if (webDriver instanceof JavascriptExecutor) {
                return ((JavascriptExecutor) webDriver).executeScript(jsCode, element);
            }
    ...
    public void backspaceAll(WebElement input) {
        Actions bulder = new Actions(webDriver);
        bulder.click(input)
    ...
    public PopUpPanel getPopUp() {
        return new PopUpPanel(webDriver, popupVisible);
    }
